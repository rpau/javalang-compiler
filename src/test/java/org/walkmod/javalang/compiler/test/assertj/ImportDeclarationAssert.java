...
public class ImportDeclarationAssert
        extends AbstractNodeAssert<ImportDeclarationAssert, ImportDeclaration> {
    ...
    public ExtListAssert<SymbolReferenceAssert, SymbolReference> usages() {
        return AssertUtil.assertThat(actual.getUsages(), SymbolReferenceAssert.class,
                navigationDescription("usages"));
    }
