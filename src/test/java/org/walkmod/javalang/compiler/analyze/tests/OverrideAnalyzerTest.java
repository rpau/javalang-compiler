...
public class OverrideAnalyzerTest extends SemanticTest {
	...
	public void testOverrideOnSimpleInnerClass() throws Exception {
		...
		MethodDeclaration method = (MethodDeclaration) ((ClassOrInterfaceDeclaration) innerClass)
				.getMembers().get(0);
	...
	private static void assertMethods(MethodDeclaration method, final List<Method> expectedOverriddenMethods) throws Exception {
