            ...
            try {
               ...
               if (typeParams == null) {
                  if (!clazz.getName().equals(field.getDeclaringClass().getName())) {
                     ...
                     List<java.lang.reflect.Type> types = ClassInspector.getInterfaceOrSuperclassImplementations(clazz,
               ...
               for (BodyDeclaration member : members) {
                  if (member instanceof FieldDeclaration) {
                     ...
                     for (VariableDeclarator var : fd.getVariables()) {
                        ...
                        table.pushSymbol(var.getId().getName(), ReferenceType.VARIABLE, symType, var, actions, true);
