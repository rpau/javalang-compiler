...
public class CompatibleFunctionalMethodPredicate<T> extends AbstractCompatibleFunctionalPredicate<T>
        implements TypeMappingPredicate<Method> {

    public CompatibleFunctionalMethodPredicate(SymbolType scope, VoidVisitor<T> typeResolver, List<Expression> args,
