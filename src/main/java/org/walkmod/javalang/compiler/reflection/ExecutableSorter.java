...
public class ExecutableSorter<T extends Executable> implements
		Comparator<T> {
				...
				for (int i = 0; i < params1.length && isMethod2First; i++) {
					...
					if (i == params1.length - 1) {
						...
						if ((isVarArgs1 && isVarArgs2)
							...
							isMethod2First = ClassInspector.isAssignable(
									clazz2, clazz1);
						...
						isMethod2First = ClassInspector.isAssignable(clazz2,
								clazz1);
					}
