...
public class GenericsBuilderFromClassParameterTypes extends
		AbstractGenericsBuilderFromParameterTypes implements
		TypeMappingBuilder<Class<?>> {

	private SymbolType scope = null;

	public GenericsBuilderFromClassParameterTypes(
			Map<String, SymbolType> typeMapping, SymbolType scope,
