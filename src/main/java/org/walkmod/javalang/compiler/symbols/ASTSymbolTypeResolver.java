...
public class ASTSymbolTypeResolver extends GenericVisitorAdapter<SymbolType, List<TypeParameter>> implements
   ...
   public SymbolType visit(ClassOrInterfaceType type, List<TypeParameter> arg) {
      ...
      if (scope == null && !isObjectCreationCtxt) {
         ...
         if (isObjectCreationCtxt) {
            scopeName = ((ObjectCreationExpr) parent).getScope().getSymbolData().getName() + ".";
         }
