...
public class OverrideAnalyzer {
    ...
    */
   private static boolean collectOverriddenMethods(MethodDeclaration md, /* Nullable */ List<Method> overriddenMethods) {
   ...
   private static boolean matchesReturnAndParameters(Method m, /* @Nullable */ Class<?> returnType, SymbolData[] args) {
