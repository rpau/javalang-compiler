...
public class TypeVisitorAdapter<A extends Map<String, Object>> extends VoidVisitorAdapter<A> {
   ...
   public void visit(MethodCallExpr n, A arg) {
      try {
         ...
         if (lookUpMethodByReflection) {
            ...
            SymbolDataOfMethodReferenceBuilder<A> typeBuilder = new SymbolDataOfMethodReferenceBuilder<A>(typeMapping,
                  this, arg);
            typeBuilder.build(n);
               ...
               if (md == null && ctxt != null) {
                  if (p.getType() == null && classes == null) {
                     ...
                     try {
                        ...
                        ClassInspector.updateTypeMappingOfInterfaceSubclass(clazz, md.getDeclaringClass(), typeMapping);
         ...
         if (n.getSymbolData() == null) {
            ...
            if (s != null) {
               ...
               if (clazz == null && data != null) {
                  ...
                  clazz = ClassInspector.findClassMember(st.getClazz().getPackage(), n.getName(), data.getClazz());
               }
               if (data != null && clazz == null) {
                  type = FieldInspector.findFieldType(symbolTable, (SymbolType) data, n.getName());
                  if (type == null) {
                     throw new NoSuchExpressionTypeException("Ops! The class " + n.toString() + " can't be resolved",
                           null);
                  }
               }
   ...
   public void visit(MethodDeclaration n, A arg) {
      ...
      try {
         SymbolType st = MethodInspector.findMethodType(symbolTable.getType("this", ReferenceType.VARIABLE), typeArgs,
         ...
         throw new NoSuchExpressionTypeException("Error resolving the signature of the method " + n.getName() + " at ["
               + n.getBeginLine() + ", " + n.getBeginColumn() + "]", e);
      }
