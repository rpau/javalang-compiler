...
public class TypesLoaderVisitor<T> extends VoidVisitorAdapter<T> {
   ...
   public TypesLoaderVisitor(SymbolTable symbolTable, SymbolActionProvider actionProvider, List<SymbolAction> actions) {
      ...
      if (!id.isAsterisk()) {
         if (!id.isStatic()) {
            ...
            if(result == null){
               ...
               symbolTable.pushSymbol(result.getSimpleName(), ReferenceType.TYPE, new SymbolType(result), id, actions, true);
            }
